...
class BasicEdge:
    def __init__(self, left_vertex, right_vertex, weight=0, orientation='-', label=None):
        ...
        self.__start = self.__get_start_vertex(self.__orientation, self.__left_vertex, self.__right_vertex)
        self.__end = self.__get_end_vertex(self.__orientation, self.__left_vertex, self.__right_vertex)
    ...
    @staticmethod
    def __validate_and_get_orientation(orientation: str) -> bool:
        if orientation in ['->', '<-', '-']:
            return orientation
        else:
    ...
    @staticmethod
    def __get_start_vertex(orientation: str, left_vertex: Vertex, right_vertex: Vertex) -> Vertex:
        return (
            None
    ...
    @staticmethod
    def __get_end_vertex(orientation: str, left_vertex: Vertex, right_vertex: Vertex) -> Vertex:
        return (
            None
            if orientation not in ['->', '<-']
